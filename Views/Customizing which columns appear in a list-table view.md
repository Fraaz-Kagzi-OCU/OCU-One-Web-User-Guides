...
1. Click the **⋮** (three-dot) menu in the top-right corner of the list screen.
   ...
   ![The three-dot menu above a Projects list](attachments/customizing-which-columns-appear-in-a-list-view/01-projects-baseline-annotated.jpg)
...
2. A panel drops down showing every column currently on the list, along with sort arrows and a remove (**x**) button for each one.
   ...
   ![The columns panel showing the current column list](attachments/customizing-which-columns-appear-in-a-list-view/02-columns-panel-open-annotated.jpg)

## Adding a column

1. Click the **+** next to **Columns** to search for a field to add.

   ![Clicking the + to add a column](attachments/customizing-which-columns-appear-in-a-list-view/02-columns-panel-open-annotated.jpg)

2. Type to search, then click the field you want — for example **Reference** (the project's reference number).

   ![Searching for and selecting the Reference field](attachments/customizing-which-columns-appear-in-a-list-view/03-add-column-picker-annotated.jpg)

3. Repeat to add more columns. Here, **Total Price (Planned)** is added the same way.

   ![Searching for and selecting Total Price (Planned)](attachments/customizing-which-columns-appear-in-a-list-view/04-add-total-price-column-annotated.jpg)

4. Each column you add appears immediately in the table and in the columns list, alongside the ones already there.

   ![Reference, Client Lead, and Total Price (Planned) added to the list](attachments/customizing-which-columns-appear-in-a-list-view/05-columns-added-annotated.jpg)
...
![Final Projects list with Reference, Total Price (Planned), and Client Lead columns, showing real values](attachments/customizing-which-columns-appear-in-a-list-view/06-reordered-final.jpg)
