...
| ----- | -------- | ------------ | ---- | ------- | ----- |
| Using the scheduling board (navigation, zoom, time span, user search) | No |  |  | v2026.09.01 |  |
| Booking a job on the scheduler | No |  |  | v2026.09.01 |  |
| Creating a job directly on the scheduler | No |  |  | v2026.09.01 |  |
| Unbooking a job from the scheduler | No |  |  | v2026.09.01 |  |
| Unallocating a job from a user on the scheduler | No |  |  | v2026.09.01 |  |
| Editing a job from the scheduler | No |  |  | v2026.09.01 |  |
| Bulk-booking many jobs | No |  |  | v2026.09.01 |  |
