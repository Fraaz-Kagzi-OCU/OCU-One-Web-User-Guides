...
1. From the Settings landing page, find **Launcher Apps** under the **Hub** section.
   ...
   ![Settings landing page with the Hub section expanded, showing Journeys, Survey Types, and Launcher Apps](attachments/configuring-app-launcher-shortcuts/00-settings-hub-section.jpg)

2. From the Launcher Apps list, click **+ Launcher App**.

   ![Launcher Apps list, empty, with the + Launcher App button](attachments/configuring-app-launcher-shortcuts/01-launcher-apps-empty.jpg)
...
3. Fill in its details:
   ...
   ![New Launcher App form filled in with name, description, URL, and an uploaded logo file](attachments/configuring-app-launcher-shortcuts/02-new-launcher-app-form.jpg)

4. Click **Create Launcher App**. It's added to the list with its logo shown as a coloured square:

   ![Launcher Apps list showing Fleet Tracker with its logo, owner, and access](attachments/configuring-app-launcher-shortcuts/03-launcher-apps-list.jpg)

Once created, the app appears for everyone in the App Launcher menu (the grid icon near the top-right of the screen):

![App Launcher dropdown menu showing Fleet Tracker as an available shortcut](attachments/configuring-app-launcher-shortcuts/04-app-launcher-menu.jpg)
...
![Fleet Tracker open for editing, showing its saved name, description, URL, and logo file](attachments/configuring-app-launcher-shortcuts/05-launcher-app-edit-view.jpg)
