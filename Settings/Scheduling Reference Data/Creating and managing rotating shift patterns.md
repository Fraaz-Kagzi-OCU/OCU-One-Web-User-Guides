...
1. From the Patterns list, click **+ Pattern**.
   ...
   ![Patterns list, empty, with the + Pattern button](attachments/creating-and-managing-rotating-shift-patterns/01-patterns-list-empty.jpg)
...
2. Fill in:
   ...
   ![New Pattern form filled in with name, description, 8-day duration, and a start date](attachments/creating-and-managing-rotating-shift-patterns/02-new-pattern-form.jpg)

3. Click **Create Pattern**. It's added to the list, showing its **Days Duration**, **Start Date**, and **State**:

   ![Patterns list showing "4-on 4-off Rotation", 8 days, starting October 01, 2026](attachments/creating-and-managing-rotating-shift-patterns/03-patterns-list-with-pattern.jpg)
...
![Newly created pattern's page, with no shifts yet and the + New Shift / Add new Shift buttons](attachments/creating-and-managing-rotating-shift-patterns/04-pattern-page-empty-shifts.jpg)
...
![New Shift form set to Thursday 07:00 through Thursday 19:00](attachments/creating-and-managing-rotating-shift-patterns/05-new-shift-form.jpg)

Click **Create Shift**. Repeat for each shift the pattern needs — here, a day shift on Thursday and another on Friday:

![Pattern page showing two shifts: "Thursday 07:00 - Thursday 19:00" and "Friday 07:00 - Friday 19:00", both active](attachments/creating-and-managing-rotating-shift-patterns/06-two-shifts-created.jpg)
...
![Edit Shift form pre-filled with the existing start/end times and days](attachments/creating-and-managing-rotating-shift-patterns/08-edit-shift-form.jpg)

Use the toggle next to a shift to deactivate it. It moves down into an **Inactive Shifts** section instead of being deleted:

![Friday shift toggled off and moved into the Inactive Shifts section](attachments/creating-and-managing-rotating-shift-patterns/07-shift-deactivated.jpg)
...
![Edit Pattern form pre-filled with the pattern's saved name, description, duration, and start date](attachments/creating-and-managing-rotating-shift-patterns/09-edit-pattern-form.jpg)
