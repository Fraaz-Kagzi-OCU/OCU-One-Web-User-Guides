...
| ----- | -------- | ------------ | ---- | ------- | ----- |
| Building a field set with field groups and field types | No |  |  | v2026.09.01 |  |
| Configuring a check-type field's pass/fail (RAG) scoring | No |  |  | v2026.09.01 |  |
| Configuring records-type field columns and auto-titles | No |  |  | v2026.09.01 |  |
