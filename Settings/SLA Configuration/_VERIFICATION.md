...
| ----- | -------- | ------------ | ---- | ------- | ----- |
| Creating an SLA type and its escalation thresholds | No |  |  | v2026.09.01 |  |
| Defining SLA stage policies | No |  |  | v2026.09.01 |  |
| Assigning SLA types to record, project, ticket, and user types | No |  |  | v2026.09.01 | Row's hint ticket type "Emergency Callout" doesn't exist; used real ticket type "Fault Report" instead |
| Configuring SLA working-hour periods | No |  |  | v2026.09.01 |  |
