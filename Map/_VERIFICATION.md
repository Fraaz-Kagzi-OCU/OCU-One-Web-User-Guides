...
| ----- | -------- | ------------ | ---- | ------- | ----- |
| Viewing the live user map | No |  |  | v2026.08.04 | Map tiles don't render in this dev environment (no Google Maps API key configured) — guide documents the sidebar user list, which is genuine. |
