...
| Editing or removing a product allocation                                   | No       |             |      | v2026.08.04 (from v2026.08.03) | Once an allocation has invoiced lines, the Edit form no longer shows the Uplift/Discount modifier section at all (was previously always shown), and a new validation blocks the change server-side too. | Yes: product-recordings-table-columns-misaligned.md |
