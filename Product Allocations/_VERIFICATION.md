...
| Editing or removing a product allocation                                   | No       |             |      | v2026.09.01 (from v2026.08.04) | Once an allocation has invoiced lines, the Edit form's Uplift/Discount section becomes a read-only label with an explanatory note instead of an editable dropdown. | Yes: product-recordings-table-columns-misaligned.md |
