...
![The Products tab with two allocations of the same product, one with a typo in its title](attachments/editing-or-removing-a-product-allocation/01-products-tab-two-allocations.jpg)
...
![The allocation's details, showing Title "Armored Cable 25mm" and the underlying product's Name, Description, and Reference](attachments/editing-or-removing-a-product-allocation/02-detail-view-overview.jpg)

Further down, a **Quantities** section shows the planned amount alongside a **Change Planned Quantity** link.

![The Quantities section, showing Planned Quantity 40 with a Change Planned Quantity link next to it](attachments/editing-or-removing-a-product-allocation/03-detail-view-quantities-annotated.jpg)
...
![The edit form: Product, Title, Product Category, and an Uplift or Discount modifier field](attachments/editing-or-removing-a-product-allocation/04-edit-form-before.jpg)
...
![The edit form with the title corrected to "Armoured Cable 25mm" and category set to "Cabling"](attachments/editing-or-removing-a-product-allocation/05-edit-form-filled.jpg)
...
![The "Are you sure you want to delete this?" confirmation dialog](attachments/editing-or-removing-a-product-allocation/07-delete-confirm-dialog.jpg)

Confirming removes it from the table straight away, and the totals at the bottom update to match:

![The Products tab afterwards, showing only the one remaining, corrected allocation](attachments/editing-or-removing-a-product-allocation/08-after-delete.jpg)
