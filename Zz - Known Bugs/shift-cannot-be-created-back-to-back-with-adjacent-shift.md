...
4. The form re-renders with: "1 error prevented this Shift from being saved — Shifts must not overlap with other Shifts", even though the new shift's hours (19:00 Thursday–07:00 Friday) never overlap the existing shift's hours (07:00–19:00 Thursday) at any point except the single instant they touch.
5. Setting the new shift's start time to one minute later (19:01) saves without any error, confirming the boundary instant itself is being treated as an overlap.
