...
| ----- | -------- | ------------ | ---- | ------- | ----- | ----- |
| Creating a survey (announcement) and setting up its questions | No |  |  | v2026.09.01 | Newly written 2026-09-12. Not yet human-verified. |  |
| Submitting, approving, and publishing a survey request | No |  |  | v2026.09.01 | Newly written 2026-09-12. Not yet human-verified. A minor, non-blocking bug was found (a redundant delete icon on the separate Edit modal 404s) — noted in the guide, doesn't affect the documented Results-page workflow. |  |
| Responding to a survey | No |  |  | v2026.09.01 | Newly written 2026-09-12. Not yet human-verified. |  |
| Viewing survey results and individual responses | No |  |  | v2026.09.01 | Newly written 2026-09-12. Documents the actual (broken) behaviour: every "Response N" link in the View Responses dropdown crashes instead of opening that response. Not yet human-verified. | Yes: survey-response-drilldown-link-goes-to-wrong-page-and-crashes.md |
