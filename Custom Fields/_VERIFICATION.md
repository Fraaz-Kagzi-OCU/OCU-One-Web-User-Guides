...
| ----- | -------- | ------------ | ---- | ------- | ----- |
| Filling in and editing custom field values on a record | No |  |  | v2026.08.04 | A related genuine bug was found while building this guide: the very first fill-in of a newly attached field group crashes (works fine once a value already exists). See `Zz - Known Bugs/first-time-filling-a-custom-field-group-crashes.md`. |
