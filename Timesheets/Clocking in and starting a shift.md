...
1. Click the clock icon in the top toolbar (next to the "powered by" logo).
   ...
   ![Clock icon in the top toolbar](attachments/clocking-in-and-starting-a-shift/01-toolbar-annotated.jpg)

2. A **Start Shift** panel drops down with two things to fill in: a Project Code and a Planned Duration.

   ![The Start Shift panel](attachments/clocking-in-and-starting-a-shift/02-start-shift-empty.jpg)
...
3. Click into the **Project Code** field and type to search for the code you're working under. Select it from the matching results.
   ...
   ![Searching for a project code](attachments/clocking-in-and-starting-a-shift/03-project-code-search.jpg)
...
4. Set your **Planned Duration** — how long you expect the shift to run. There are two ways to do this:
   ...
   ![Choosing a preset planned duration](attachments/clocking-in-and-starting-a-shift/04-duration-preset-open.jpg)
   ...
   ![Entering a custom planned duration](attachments/clocking-in-and-starting-a-shift/04b-duration-custom.jpg)
...
5. With both fields filled in, click **Start Shift**.
   ...
   ![Project code and duration filled in, ready to start](attachments/clocking-in-and-starting-a-shift/05-form-filled.jpg)

## Once your shift has started

The panel switches to show your shift is now active:

![Shift Active panel showing the running timer](attachments/clocking-in-and-starting-a-shift/06-shift-active.jpg)
...
![Green dot on the toolbar clock icon indicating an active shift](attachments/clocking-in-and-starting-a-shift/07-toolbar-active-indicator-annotated.jpg)
