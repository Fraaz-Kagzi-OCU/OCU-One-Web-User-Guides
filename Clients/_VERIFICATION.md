...
- **Blocked** — `Yes: <bug file>.md` when an open app bug means the guide's own content can't be trusted yet; this keeps the guide off the verification site until the bug is fixed (see `Zz - Bugged Guides.md` and `WORKFLOW.md`). Blank otherwise.
...
| ------------------------------------------------------------------------ | -------- | ----------- | ---- | ----------- | ------- | ----- |
| Viewing and filtering the client list                                  | No       |             |      | v2026.09.01 |         |       |
| Creating and editing a client                                          | No       |             |      | v2026.09.01 |         |       |
| Client overview, todos, jobs, and linked records tabs                  | No       |             |      | v2026.09.01 |         |       |
| Viewing a client's invoices                                            | No       |             |      | v2026.09.01 | Yes: clients-invoices-tab-route-has-no-controller-action-or-ui-link.md | Route has no controller action or UI link — confirmed broken |
| Downloading a client PDF summary                                       | No       |             |      | v2026.09.01 | Yes: clients-pdf-download-route-has-no-controller-action-or-ui-link.md | Route has no controller action or UI link — confirmed broken |
| Managing a client's sites                                              | No       |             |      | v2026.09.01 |         |       |
| Site detail — overview and linked assets                               | No       |             |      | v2026.09.01 |         |       |
| Archiving a client                                                     | No       |             |      | v2026.09.01 |         |       |
